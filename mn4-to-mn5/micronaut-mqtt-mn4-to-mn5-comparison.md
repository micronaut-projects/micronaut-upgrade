• Generated the comparison report here:
  ...
  micronaut-mqtt-mn4-to-mn5-comparison.md:1

  Scope: mn4 previous is 3.8.x at 9e8f5053016c, clean. mn5 current is 4.0.x at 03c697dfd34a, clean. The comparison found 45 commit candidates and 175 changed files.
  ...
  - Replaced Micronaut nullability annotations with JSpecify annotations across MQTT APIs.
  - Updated HiveMQ MQTT Client from `1.3.10` to `1.3.14`.
  - Eclipse Paho MQTT v3 and v5 clients remain at `1.2.5`.

  ### Dependency Updates

  - Updated Micronaut Core from `4.10.4` to `5.0.0-RC2`.
  - Updated Micronaut Reactor from `3.9.0` to `4.0.0-RC1`.
  - Updated Micronaut Serialization from `2.15.5` to `3.0.0-RC2`.
  - Updated Micronaut Validation from `4.11.0` to `5.0.0-RC2`.
  - Switched SSL support from `org.bouncycastle:bcpkix-jdk15on:1.70` to `org.bouncycastle:bcpkix-jdk18on:1.84`.

  ### Internal / Build

  - Updated Gradle from `8.14.3` to `9.5.0`.
  - Updated the Micronaut build shared settings plugin from `7.6.4` to `8.0.0-M18`.
  - Removed Micronaut Test Resources catalog wiring and moved test infrastructure toward direct Testcontainers dependencies.
  - Converted shared MQTT test utilities from Groovy to Java and added dedicated Mosquitto/HiveMQ test helpers.

  I did not find a new 4.0-specific breaking-change document; breaks.adoc still documents the older 3.0 annotation package move. I did not run tests; this is a static git/filesystem comparison.
...
| Current | `/Users/sdelamo/github/micronaut/mn5/micronaut-mqtt` | `4.0.x` | `03c697dfd34a` | `git@github.com:micronaut-projects/micronaut-mqtt.git` | `False` |
...
| `gradle.properties` | `projectVersion` | `3.8.0-SNAPSHOT` | `4.0.0-SNAPSHOT` | `changed` |
...
| `gradle/libs.versions.toml` | `libraries.micronaut-gradle-plugin` | `io.micronaut.gradle:micronaut-gradle-plugin:4.5.5` | `io.micronaut.gradle:micronaut-gradle-plugin:4.6.2` | `changed` |
...
| `gradle/libs.versions.toml` | `versions.micronaut-gradle-plugin` | `4.5.5` | `4.6.2` | `changed` |
