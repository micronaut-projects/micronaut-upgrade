Compared micronaut-pulsar as mn4 → mn5.

  Scope

  - Base: /Users/sdelamo/github/micronaut/mn4/micronaut-pulsar, branch 2.7.x, SHA 394e775
  - Target: /Users/sdelamo/github/micronaut/mn5/micronaut-pulsar, branch 3.0.x, SHA d96ec9f
  - Report: /private/tmp/micronaut-pulsar-2.7-to-3.0-comparison.md

  Key Findings

  - projectVersion moves from 2.7.1-SNAPSHOT to 3.0.1-SNAPSHOT.
  - Core platform moves to Micronaut 5.0.0; Gradle wrapper moves 8.14.3 → 9.5.1; Java 25.0.1-graal is added
    via .sdkmanrc.
  - Pulsar client moves 3.3.9 → 4.2.1.
  - Related Micronaut integrations move forward: gRPC 4.12.0 → 5.0.0, Multitenancy 5.8.0 → 6.0.0, Reactor 3.9.0
    → 4.0.0, Serde 2.15.5 → 3.0.0, Validation 4.11.0 → 5.0.0.
  - Pulsar client configuration adds proxy URL/protocol support, with SNI as the default proxy protocol when a
    proxy URL is configured.
  - Protobuf schema handling was updated for the newer Pulsar/protobuf stack.
  - Public nullability annotations moved from Micronaut annotations to JSpecify.
  - Doc examples were moved from test sources to main sources, with docs updated to reference the new snippet
    source location.
  - Build cleanup includes Kotlin DSL conversion for pulsar-multitenant, removal of old dependency constraints,
    and OSV vulnerability audit configuration.

  Diff size: 102 files changed, 4002 insertions, 1026 deletions. I did not run tests; this was a folder
  comparison only.

# Release Note Comparison

Generated: 2026-05-19 09:54 UTC
Comparison: `2.7.x` -> `3.0.x`
Mode: git
...
| Current | `/Users/sdelamo/github/micronaut/mn5/micronaut-pulsar` | `3.0.x` | `d96ec9f83e79` | `git@github.com:micronaut-projects/micronaut-pulsar.git` | `False` |

## Summary Signals

- Same remote: `True`
- Diff repository: `/Users/sdelamo/github/micronaut/mn5/micronaut-pulsar`
- Commit candidates found: 95
- File changes listed: 102
- Version values listed: 26
- File status counts: A=29, D=3, M=58, R=12
...
| `gradle.properties` | `projectVersion` | `2.7.1-SNAPSHOT` | `3.0.1-SNAPSHOT` | `changed` |
...
| `gradle/libs.versions.toml` | `versions.micronaut-multitenancy` | `5.8.0` | `6.0.0` | `changed` |
...
- `8bde3ccdf970` add osv-scanner.toml (Sergio del Amo, 2026-05-18)
...
- `a3b328c7df61` chore: Bump version to 3.0.1-SNAPSHOT (micronaut-build, 2026-05-18)
- `8e96968f8172` chore: Bump version to 3.0.0-SNAPSHOT (micronaut-build, 2026-05-07)
...
- `d96ec9f83e79` micronaut-test-resources = "4.0.0" (Sergio del Amo, 2026-05-19)
- `9042c6372f25` [skip ci] Release v3.0.0 (micronaut-build, 2026-05-18)
- `7946c940c4a0` update versions (Sergio del Amo, 2026-05-18)
- `9c37156ff6c8` Update common files (#805) (micronaut-build, 2026-05-18)
- `b3fbb41947a9` Update mikepenz/action-junit-report digest to 3a81627 (#804) (renovate[bot], 2026-05-18)
- `5a7a0dd34d45` micronaut-multitenancy = "6.0.0" (Sergio del Amo, 2026-05-17)
- `e483f97fb873` Update common files (#803) (micronaut-build, 2026-05-14)
- `d14046ca2160` Update versions (Sergio del Amo, 2026-05-14)
- `40982350157f` micronaut-gradle-plugin = '5.0.0-M1' (Sergio del Amo, 2026-05-13)
- `db59e0c7ecae` micronaut-platform = '5.0.0-RC1' (Sergio del Amo, 2026-05-13)
- `68d6f4ef5823` micronaut = "5.0.0" (Sergio del Amo, 2026-05-13)
- `c66f2281af12` Update common files (#802) (micronaut-build, 2026-05-09)
- `c82aaf781d0e` [skip ci] Release v3.0.0-RC1 (micronaut-build, 2026-05-07)
- `a6f46279c479` Update common files (#801) (micronaut-build, 2026-05-07)
