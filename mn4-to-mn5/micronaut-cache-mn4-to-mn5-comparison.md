 Generated the comparison report here:
  ...
  micronaut-cache-mn4-to-mn5-comparison.md:1

  Scope: mn4 previous is 5.3.x at 9551c48f88f5, clean. mn5 current is 6.0.x at 052b1eb8f688, clean. The comparison found 92 commit candidates and 104 changed files.
  ...
  - Replaced Micronaut nullability annotations with JSpecify annotations across cache core, Caffeine, Ehcache, Hazelcast, Infinispan, JCache, and NoOp cache APIs.

  ### Documentation

  - Added documentation for Micronaut Control Panel cache support via `io.micronaut.controlpanel:micronaut-control-panel-cache`.

  ### Dependency Updates

  - Updated Caffeine from `3.2.1` to `3.2.4`.
  - Updated Ehcache from `3.10.8` to `3.12.0`.
  - Updated Hazelcast from `5.3.7` to `5.6.0`.
  - Updated Infinispan from `15.2.4.Final` to `16.1.4`.
  - JCache API and RI remain at `1.1.1`.

  ### Internal / Build

  - Updated Gradle from `8.14.2` to `9.5.0`.
  - Updated GraalVM native-image dependencies from `23.1.7` to `25.0.3`.
  - Updated the GraalVM build tools plugin from `0.10.6` to `0.11.5`.
  - Converted `cache-tck` build configuration to Kotlin DSL.
  - Removed Sonatype scan plugin wiring from the cache module build.

  Key version changes:

  - Project version: 5.3.1-SNAPSHOT -> 6.0.0-SNAPSHOT
  - Micronaut Core: 4.9.4 -> 5.0.0-RC2
  - Micronaut Micrometer: 5.11.0 -> 6.0.1-M1
  - Micronaut Serialization: 2.15.4 -> 3.0.0-RC2
  - Micronaut Validation: 4.9.0 -> 5.0.0-RC2
  - Micronaut Test Resources: 2.8.0 -> 4.0.0-M1

  I did not find a new 6.0-specific breaking-change document. I did not run tests; this is a static git/filesystem comparison.


# Release Note Comparison

Generated: 2026-05-07 11:05 UTC
Comparison: `mn4` -> `mn5`
Mode: git
...
| Current | `/Users/sdelamo/github/micronaut/mn5/micronaut-cache` | `6.0.x` | `052b1eb8f688` | `git@github.com:micronaut-projects/micronaut-cache.git` | `False` |

## Summary Signals

- Same remote: `True`
- Diff repository: `/Users/sdelamo/github/micronaut/mn5/micronaut-cache`
- Commit candidates found: 92
...
| `gradle.properties` | `projectVersion` | `5.3.1-SNAPSHOT` | `6.0.0-SNAPSHOT` | `changed` |
...
| `gradle/libs.versions.toml` | `libraries.gradle-graal` | `org.graalvm.buildtools.native:org.graalvm.buildtools.native.gradle.plugin:0.10.6` | `org.graalvm.buildtools.native:org.graalvm.buildtools.native.gradle.plugin:0.11.5` | `changed` |
...
| `gradle/libs.versions.toml` | `libraries.micronaut-micrometer` | `io.micronaut.micrometer:micronaut-micrometer-bom:5.11.0` | `io.micronaut.micrometer:micronaut-micrometer-bom:6.0.1-M1` | `changed` |
| `gradle/libs.versions.toml` | `libraries.micronaut-serde` | `io.micronaut.serde:micronaut-serde-bom:2.15.4` | `io.micronaut.serde:micronaut-serde-bom:3.0.0-RC2` | `changed` |
| `gradle/libs.versions.toml` | `libraries.micronaut-test-resources` | `io.micronaut.testresources:micronaut-test-resources-bom:2.8.0` | `io.micronaut.testresources:micronaut-test-resources-bom:4.0.0-M1` | `changed` |
...
| `gradle/libs.versions.toml` | `versions.graal-plugin` | `0.10.6` | `0.11.5` | `changed` |
...
| `gradle/libs.versions.toml` | `versions.micronaut` | `4.9.4` | `5.0.0-RC2` | `changed` |
...
| `gradle/libs.versions.toml` | `versions.micronaut-micrometer` | `5.11.0` | `6.0.1-M1` | `changed` |
| `gradle/libs.versions.toml` | `versions.micronaut-serde` | `2.15.4` | `3.0.0-RC2` | `changed` |
| `gradle/libs.versions.toml` | `versions.micronaut-test` | `4.7.0` | `not present` | `removed` |
| `gradle/libs.versions.toml` | `versions.micronaut-test-resources` | `2.8.0` | `4.0.0-M1` | `changed` |
...
| `gradle/wrapper/gradle-wrapper.properties` | `gradle-wrapper` | `8.14.2` | `9.5.0` | `changed` |
