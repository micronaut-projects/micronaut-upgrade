Compared micronaut-grpc as mn4 → mn5.

  Scope:

  - Base: /Users/sdelamo/github/micronaut/mn4/micronaut-grpc, branch 4.13.x, SHA e78c3c61b660
  - Target: /Users/sdelamo/github/micronaut/mn5/micronaut-grpc, branch 5.0.x, SHA 47a2b8986fbe
  - Report: /private/tmp/micronaut-grpc-4.13-to-5.0-comparison.md

  Key findings:

  - Major baseline move: project version 4.13.0-SNAPSHOT → 5.0.1-SNAPSHOT, Micronaut 4.10.4 → 5.0.0, Micronaut
    Platform 4.9.4 → 5.0.0-RC1.
  - Build stack changed: Gradle 8.14.3 → 9.5.1, Micronaut Gradle plugin 4.5.4 → 5.0.0-M1, shared settings
    plugin 7.6.4 → 8.0.0-M18, .sdkmanrc now pins 25.0.1-graal.
  - gRPC/protobuf stack moved: gRPC 1.75.0 → 1.80.0, Protobuf 3.25.8 → 4.34.1, protobuf Gradle plugin 0.9.5 →
    0.9.6, gRPC Kotlin 1.4.3 → 1.5.0.
  - New optional grpc-inprocess module adds in-process server/channel support via grpc.server.in-process-name,
    intended for tests without opening a TCP port.
  - Server config gained grpc.server.executor to select a named Executor bean, plus a gRPC-owned
    ResourceResolver fallback so SSL resources work without the HTTP resource factory.
  - Client runtime now supports disabling all or named gRPC clients via grpc.client.enabled=false or
    grpc.client.<name>.enabled=false; optional injection resolves empty while required injection fails.
  - Docs/examples added reactive-grpc setup, Reactor stub usage, Kotest example coverage, and updated tracing
    guidance toward OpenTelemetry gRPC integration.

  Diff size: 111 files changed, 5354 insertions(+), 274 deletions(-). I did not run tests; this was a folder
  comparison only.

# Release Note Comparison

Generated: 2026-05-19 10:27 UTC
Comparison: `4.13.x` -> `5.0.x`
Mode: git
...
| Current | `/Users/sdelamo/github/micronaut/mn5/micronaut-grpc` | `5.0.x` | `47a2b8986fbe` | `git@github.com:micronaut-projects/micronaut-grpc.git` | `False` |

## Summary Signals

- Same remote: `True`
- Diff repository: `/Users/sdelamo/github/micronaut/mn5/micronaut-grpc`
- Commit candidates found: 110
- File changes listed: 111
- Version values listed: 16
- File status counts: A=44, M=61, R=6
...
| `gradle.properties` | `projectVersion` | `4.13.0-SNAPSHOT` | `5.0.1-SNAPSHOT` | `changed` |
...
- `2a4e56917f5b` chore: Bump version to 5.0.1-SNAPSHOT (micronaut-build, 2026-05-18)
- `f816ae54747f` chore: Bump version to 5.0.0-SNAPSHOT (micronaut-build, 2026-05-06)
...
- `47a2b8986fbe` micronaut-tracing = "8.0.0" (Sergio del Amo, 2026-05-19)
- `db8195a44f62` Update common files (#1210) (micronaut-build, 2026-05-19)
- `7af58d374d55` micronaut-kotlin = "5.0.0" (Sergio del Amo, 2026-05-18)
- `761b72ef6970` [skip ci] Release v5.0.0 (micronaut-build, 2026-05-18)
- `7af7d53c2507` micronaut-test = "5.0.0" (Sergio del Amo, 2026-05-14)
- `88103c042549` Update versions (Sergio del Amo, 2026-05-14)
- `836c434f0cb4` Update common files (#1208) (micronaut-build, 2026-05-14)
- `74c52e938bee` micronaut-platform = "5.0.0-RC1" (Sergio del Amo, 2026-05-13)
- `dd8c9ef0c8cc` micronaut = "5.0.0" (Sergio del Amo, 2026-05-13)
- `47507d0559bc` Update common files (#1207) (micronaut-build, 2026-05-09)
- `4b4e18d95601` [skip ci] Release v5.0.0-RC1 (micronaut-build, 2026-05-06)
