Compared micronaut-jackson-xml as mn4 → mn5.

  Scope:

  - Base: /Users/sdelamo/github/micronaut/mn4/micronaut-jackson-xml, branch 4.8.x, SHA a00a55125ccb
  - Target: /Users/sdelamo/github/micronaut/mn5/micronaut-jackson-xml, branch 5.0.x, SHA f5b3d51baf4f
  - Report: /private/tmp/micronaut-jackson-xml-4.8-to-5.0-comparison.md

  Key findings:

  - Main breaking signal: io.micronaut.xml.jackson.codec.XmlMediaTypeCodec and its package-info/test were
    deleted. XML handling now goes through XmlMessageHandler / MessageBodyHandler.
  - Micronaut baseline moved 4.10.5 → 5.0.0; project version 4.8.1-SNAPSHOT → 5.0.1-SNAPSHOT.
  - Jackson XML code migrated from com.fasterxml.jackson.* dataformat/databind APIs to tools.jackson.*; XML
    config types changed from FromXmlParser.Feature / ToXmlGenerator.Feature to XmlReadFeature /
    XmlWriteFeature.
  - Build stack changed: Gradle wrapper 8.14.3 → 9.5.1, Micronaut Gradle plugin 4.5.5 → 5.0.0-M1, shared
    settings plugin 7.6.4 → 8.0.0-M18, and .sdkmanrc now pins 25.0.1-graal.
  - Native-image/test support was updated for Jackson 3-era classes, including
    tools.jackson.dataformat.xml.XmlMapper / XmlFactory.

  Diff size: 72 files changed, 4024 insertions(+), 443 deletions(-). I did not run tests; this was a folder
  comparison only.

# Release Note Comparison

Generated: 2026-05-19 10:18 UTC
...
| Current | `/Users/sdelamo/github/micronaut/mn5/micronaut-jackson-xml` | `5.0.x` | `f5b3d51baf4f` | `git@github.com:micronaut-projects/micronaut-jackson-xml.git` | `False` |

## Summary Signals

- Same remote: `True`
- Diff repository: `/Users/sdelamo/github/micronaut/mn5/micronaut-jackson-xml`
- Commit candidates found: 63
- File changes listed: 72
- Version values listed: 16
- File status counts: A=26, D=3, M=43
...
| `gradle.properties` | `projectVersion` | `4.8.1-SNAPSHOT` | `5.0.1-SNAPSHOT` | `changed` |
...
- `e3c1f4ccb380` chore: Bump version to 5.0.1-SNAPSHOT (micronaut-build, 2026-05-14)
- `6bcfbbab77c3` chore: Bump version to 5.0.0-SNAPSHOT (micronaut-build, 2026-05-06)
...
- `f5b3d51baf4f` Update common files (#527) (micronaut-build, 2026-05-19)
- `4fc1e74ae41a` Update common files (#526) (micronaut-build, 2026-05-14)
- `e265e1ddcf90` [skip ci] Release v5.0.0 (micronaut-build, 2026-05-14)
- `959e7ce6007b` micronaut = "5.0.0" (Sergio del Amo, 2026-05-13)
- `0458f588ce04` Update common files (#525) (micronaut-build, 2026-05-09)
- `b7ec4219dd41` [skip ci] Release v5.0.0-RC1 (micronaut-build, 2026-05-06)
