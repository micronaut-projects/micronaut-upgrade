...
• Generated the comparison report here:
  ...
  micronaut-crac-mn4-to-mn5-comparison.md:1

  Scope: mn4 previous is 2.8.x at 16c1ed51fd6d, clean. mn5 current is 3.0.x at 435bc354fa49, clean. The comparison found 51 commit candidates and 70 changed files.
  ...
  - Replaced Micronaut nullability annotations with JSpecify annotations across CRaC APIs and DataSource resolver APIs.
  - `org.crac:crac` remains at `1.5.0`.

  ### Dependency Updates

  - Updated Micronaut Core from `4.10.4` to `5.0.0-RC2`.
  - Updated Micronaut Platform from `4.9.4` to `5.0.0-M3`.
  - Updated Micronaut Data from `4.13.7` to `5.0.0-M7`.
  - Updated Micronaut Cache from `5.3.0` to `6.0.0-M3`.
  - Updated Micronaut Redis from `6.9.0` to `7.0.0-M2`.
  - Updated Micronaut SQL from `6.3.1` to `7.0.1-M3`.
  - Updated Micronaut Serialization from `2.15.5` to `3.0.0-RC2`.

  ### Internal / Build

  - Updated Gradle from `8.14.3` to `9.5.0`.
  - Updated the Micronaut build shared settings plugin from `7.6.4` to `8.0.0-M18`.
  - Updated the Micronaut Gradle and CRaC Gradle plugins from `4.5.5` to `5.0.0-M1`.
  - Removed Micronaut Test Resources wiring from the Redis test suite and switched to direct Testcontainers dependencies, adding `com.redis.testcontainers:testcontainers-redis:1.6.4`.
  - Removed Sonatype scan plugin wiring from the CRaC module build.

  I did not find a new 3.0-specific breaking-change document or a confirmed user-visible CRaC resource behavior change beyond the Micronaut 5/JSpecify compatibility work. I did not run tests; this is a static git/filesystem
  comparison.


# Release Note Comparison

Generated: 2026-05-07 10:08 UTC
Comparison: `mn4` -> `mn5`
Mode: git
...
| Current | `/Users/sdelamo/github/micronaut/mn5/micronaut-crac` | `3.0.x` | `435bc354fa49` | `git@github.com:micronaut-projects/micronaut-crac.git` | `False` |
...
| `gradle.properties` | `projectVersion` | `2.8.0-SNAPSHOT` | `3.0.0-SNAPSHOT` | `changed` |
...
| `gradle/libs.versions.toml` | `libraries.micronaut-data` | `io.micronaut.data:micronaut-data-bom:4.13.7` | `io.micronaut.data:micronaut-data-bom:5.0.0-M7` | `changed` |
| `gradle/libs.versions.toml` | `libraries.micronaut-redis` | `io.micronaut.redis:micronaut-redis-bom:6.9.0` | `io.micronaut.redis:micronaut-redis-bom:7.0.0-M2` | `changed` |
...
| `gradle/libs.versions.toml` | `versions.micronaut-data` | `4.13.7` | `5.0.0-M7` | `changed` |
...
| `gradle/libs.versions.toml` | `versions.micronaut-redis` | `6.9.0` | `7.0.0-M2` | `changed` |
| `gradle/libs.versions.toml` | `versions.micronaut-serialization` | `2.15.5` | `3.0.0-RC2` | `changed` |
