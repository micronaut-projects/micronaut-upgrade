Compared as mn4/1.11.x -> mn5/2.0.x based on branch metadata.

  Scope:

  - Base: /Users/sdelamo/github/micronaut/mn4/micronaut-eclipsestore, branch 1.11.x, commit
    93dd81e8e9d168681df35ab2c94d975104da1f22
  - Target: /Users/sdelamo/github/micronaut/mn5/micronaut-eclipsestore, branch 2.0.x, commit
    c4498054a4f15ee3a4cbde2080125542288e1065
  - Both worktrees are clean and use the same remote.

  Full report: /private/tmp/micronaut-eclipsestore-1.11-to-2.0-comparison.md:1

  Key findings:

  - 147 files changed: 40 added, 2 deleted, 95 modified, 10 renamed; 4,549 insertions, 398 deletions.
  - Main platform moves to Micronaut 5: projectVersion 1.11.0-SNAPSHOT -> 2.0.1-SNAPSHOT, micronaut 4.10.4 ->
    5.0.0.
  - Confirmed breaking change: annotation mappers moved from micronaut-eclipsestore-annotations to new module
    micronaut-eclipsestore-processor. Users must replace the annotation processor or Groovy compileOnly
    dependency accordingly.
  - New feature: Google Cloud Firestore storage target support was added, including
    eclipsestore.firestore.storage.* configuration, provider/factory classes, docs, and tests.
  - EclipseStore managed dependency moves from 1.4.0 -> 4.0.1; persistence-binary-jdk17 is removed and
    StorageManagerFactory no longer explicitly registers JDK 17 binary handlers.
  - Major dependency updates include AWS 4.11.0 -> 5.0.0, Azure 5.12.0 -> 6.0.0, Cache 5.3.0 -> 6.0.0,
    Micrometer 5.13.0 -> 6.0.0, Serde 2.15.5 -> 3.0.0, SQL 6.3.1 -> 7.0.1, Validation 4.11.0 -> 5.0.0.
  - Build baseline changes: Gradle 8.14.3 -> 9.5.1, shared settings plugin 7.6.4 -> 8.0.0-M18, .sdkmanrc adds
    java=25.0.1-graal, and settings.gradle was converted to settings.gradle.kts.
  - Micronaut test resources usage was removed from the main build/test setup; tests now use direct
    Testcontainers dependencies.
  - Existing source largely migrated nullability annotations to JSpecify, with the new Firestore code added
    separately.

# Release Note Comparison

Generated: 2026-05-19 09:28 UTC
...
| Current | `/Users/sdelamo/github/micronaut/mn5/micronaut-eclipsestore` | `2.0.x` | `c4498054a4f1` | `git@github.com:micronaut-projects/micronaut-eclipsestore.git` | `False` |
...
| `gradle.properties` | `projectVersion` | `1.11.0-SNAPSHOT` | `2.0.1-SNAPSHOT` | `changed` |
...
- `9a53a4412ee1` remove unused versions (Sergio del Amo, 2026-05-07)
...
- `208ae3a00fef` chore: Bump version to 2.0.1-SNAPSHOT (micronaut-build, 2026-05-14)
- `cac3ac1947a6` chore: Bump version to 2.0.0-SNAPSHOT (micronaut-build, 2026-05-07)
...
- `c4498054a4f1` micronaut-aws = "5.0.0" (Sergio del Amo, 2026-05-19)
- `b4ba115a715c` Update common files (#282) (micronaut-build, 2026-05-19)
- `fbc7f2f0c146` micronaut-azure = "6.0.0" (Sergio del Amo, 2026-05-18)
- `86793fc414c7` micronaut-sql = "7.0.1" (Sergio del Amo, 2026-05-18)
- `0f13fc5efd35` micronaut cache (Sergio del Amo, 2026-05-14)
- `d1fde5c437c3` [skip ci] Release v2.0.0 (micronaut-build, 2026-05-14)
- `5a16fe60ab8e` Update versions (Sergio del Amo, 2026-05-14)
- `7d10fbe3779c` Update common files (#279) (micronaut-build, 2026-05-14)
- `ca3bdaa101b6` micronaut = "5.0.0" (Sergio del Amo, 2026-05-13)
- `6a0a6745dce7` Update common files (#278) (micronaut-build, 2026-05-09)
- `3d0466cadf6a` [skip ci] Release v2.0.0-RC1 (micronaut-build, 2026-05-07)
