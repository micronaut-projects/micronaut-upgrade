 Compared micronaut-json-schema as mn4 -> mn5.

  Scope

  - Base: /Users/sdelamo/github/micronaut/mn4/micronaut-json-schema, branch 1.8.x, SHA 4f3e0af862c2
  - Target: /Users/sdelamo/github/micronaut/mn5/micronaut-json-schema, branch 2.0.x, SHA e0d48e4109d9
  - Same remote, both clean: git@github.com:micronaut-projects/micronaut-json-schema.git
  - Report: /private/tmp/micronaut-json-schema-1.8-to-2.0-comparison.md

  Key Findings

  - Major line move: 1.8.0-SNAPSHOT -> 2.0.1-SNAPSHOT.
  - Platform/build upgrade: Micronaut 4.10.4 -> 5.0.0, Gradle 8.14.3 -> 9.5.1, Java/GraalVM 25.0.1-graal,
    shared settings plugin 7.6.6 -> 8.0.0-M18.
  - New json-schema-configuration-validator module with CLI, runtime API, HTML/JSON reports, management
    endpoint, health indicator, custom ConfigurationRule SPI, and optional metadata-based DI validation.
  - JsonSchemaClassPathResourceLoader gained bulk schema discovery plus a default/composite loader; it now
    supports both generated schemas and Micronaut configuration schemas.
  - Validation moved to com.networknt:json-schema-validator 1.5.8 -> 3.0.2, using SchemaRegistryConfig /
    Error APIs internally.
  - JSON schema serialization/generation internals moved to Jackson 3 tools.jackson.* types, including
    JsonSchemaMapperFactory.createMapper().
  - Generator support improved for const values: generated fields are private with getter/setter, and const
    types are inferred from the const value.
  - @JsonUnwrapped handling was improved for referenced/generated schemas.
  - Added support for validating deprecated/unknown configuration properties, suppressions, test-resources
    placeholders, and datasource/JPA-related validation rules.
  - Common CI/template updates added vulnerability audit scripts, Sonatype workflow, and shared agent skill
    files.

  Diff size: 255 files changed, 18250 insertions(+), 377 deletions(-).

  I did not run tests; this was a folder comparison and targeted source/build-diff review only.

# Release Note Comparison

Generated: 2026-05-19 14:19 UTC
Comparison: `1.8.x` -> `2.0.x`
Mode: git
...
| Current | `/Users/sdelamo/github/micronaut/mn5/micronaut-json-schema` | `2.0.x` | `e0d48e4109d9` | `git@github.com:micronaut-projects/micronaut-json-schema.git` | `False` |

## Summary Signals

- Same remote: `True`
- Diff repository: `/Users/sdelamo/github/micronaut/mn5/micronaut-json-schema`
- Commit candidates found: 148
- File changes listed: 255
- Version values listed: 27
- File status counts: A=191, M=64
...
| `gradle.properties` | `projectVersion` | `1.8.0-SNAPSHOT` | `2.0.1-SNAPSHOT` | `changed` |
...
| `gradle/libs.versions.toml` | `libraries.micronaut-sourcegen` | `io.micronaut.sourcegen:micronaut-sourcegen-bom:1.8.2` | `io.micronaut.sourcegen:micronaut-sourcegen-bom:2.0.0` | `changed` |
...
| `gradle/libs.versions.toml` | `versions.micronaut-sourcegen` | `1.8.2` | `2.0.0` | `changed` |
...
- `903651ad5d4f` chore: Bump version to 2.0.1-SNAPSHOT (micronaut-build, 2026-05-14)
...
- `e0d48e4109d9` Update common files (#356) (micronaut-build, 2026-05-19)
- `95eab4b2c703` micronaut-sourcegen = "2.0.0" (Sergio del Amo, 2026-05-17)
- `6fbb56d4cccc` [skip ci] Release v2.0.0 (micronaut-build, 2026-05-14)
- `85e19ce164bc` fix indentation (Sergio del Amo, 2026-05-14)
- `972218e0af56` Update common files (#355) (micronaut-build, 2026-05-14)
- `13fe6271d82d` Update versions (Sergio del Amo, 2026-05-14)
- `edadf033e2ca` micronaut = "5.0.0" (Sergio del Amo, 2026-05-13)
- `7588f147238a` Update common files (#353) (micronaut-build, 2026-05-09)
...
- `M` json-schema-generator/src/test/groovy/io/micronaut/jsonschema/generator/EnumGeneratorSpec.groovy
- `M` json-schema-generator/src/test/groovy/io/micronaut/jsonschema/generator/SimpleGeneratorSpec.groovy
