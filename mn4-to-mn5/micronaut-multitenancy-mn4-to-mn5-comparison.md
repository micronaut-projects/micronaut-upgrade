...
• Compared in release direction mn4 -> mn5.
  ...
  Full report: micronaut-multitenancy-mn4-to-mn5-comparison.md:1

  Scope:

  - Previous: mn4/micronaut-multitenancy, branch 5.8.x, commit eb9e1188b261, clean
  - Current: mn5/micronaut-multitenancy, branch 6.0.x, commit 96a9f73812b7, clean
  - Delta: 65 commit candidates, 67 changed files

  Release-note draft:

  ## Micronaut Multitenancy 6.0

  ### Breaking Changes

  - Removed the previously deprecated no-argument `SubdomainTenantResolver()` constructor. Use `SubdomainTenantResolver(HttpHostResolver)` instead.

  ### Compatibility

  - Updated for the Micronaut 5 baseline.
  - Replaced Micronaut nullability annotations with JSpecify annotations across the multitenancy API.

  ### Dependency Updates

  - Updated Micronaut Core from `4.10.4` to `5.0.0-RC2`.
  - Updated Micronaut Security from `4.15.0` to `5.0.0-M2`.
  - Updated Micronaut Session from `4.7.0` to `5.0.0-M2`.
  - Updated Micronaut Serialization from `2.15.5` to `3.0.0-M8`.
  - Updated Micronaut Validation from `4.11.0` to `5.0.0-M2`.
  - Updated Micronaut Reactor from `3.9.0` to `4.0.0-M2`.

  Other notable changes:

  - Project version: 5.8.1-SNAPSHOT -> 6.0.0-SNAPSHOT
  - Gradle wrapper: 8.14.3 -> 9.5.0
  - Micronaut build shared settings plugin: 7.6.4 -> 8.0.0-M18
  - Guava: 33.4.8-jre -> 33.6.0-jre
  - Public suffix list: 2.2.0 -> 2.2.4
  - Commons Lang constraint: 3.18.0 -> 3.20.0

  Tests were not run; this was a static repository comparison.

# Release Note Comparison

Generated: 2026-05-06 16:38 UTC
Comparison: `mn4` -> `mn5`
Mode: git
...
| Current | `/Users/sdelamo/github/micronaut/mn5/micronaut-multitenancy` | `6.0.x` | `96a9f73812b7` | `git@github.com:micronaut-projects/micronaut-multitenancy.git` | `False` |

## Summary Signals

- Same remote: `True`
- Diff repository: `/Users/sdelamo/github/micronaut/mn5/micronaut-multitenancy`
- Commit candidates found: 65
- File changes listed: 67
- Version values listed: 26
- File status counts: A=18, M=49
...
| `gradle.properties` | `projectVersion` | `5.8.1-SNAPSHOT` | `6.0.0-SNAPSHOT` | `changed` |
| `gradle/libs.versions.toml` | `libraries.gradle-kotlin` | `org.jetbrains.kotlin:kotlin-gradle-plugin:1.9.25` | `not present` | `removed` |
| `gradle/libs.versions.toml` | `libraries.micronaut-reactor` | `io.micronaut.reactor:micronaut-reactor-bom:3.9.0` | `io.micronaut.reactor:micronaut-reactor-bom:4.0.0-M2` | `changed` |
...
| `gradle/libs.versions.toml` | `libraries.micronaut-serde` | `io.micronaut.serde:micronaut-serde-bom:2.15.5` | `io.micronaut.serde:micronaut-serde-bom:3.0.0-M8` | `changed` |
...
| `gradle/libs.versions.toml` | `versions.micronaut-reactor` | `3.9.0` | `4.0.0-M2` | `changed` |
| `gradle/libs.versions.toml` | `versions.micronaut-security` | `4.15.0` | `5.0.0-M2` | `changed` |
| `gradle/libs.versions.toml` | `versions.micronaut-serde` | `2.15.5` | `3.0.0-M8` | `changed` |
