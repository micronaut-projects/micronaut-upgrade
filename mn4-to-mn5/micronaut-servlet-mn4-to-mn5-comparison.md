Compared as mn4 -> mn5.
  ...
  Full report: micronaut-servlet-mn4-to-mn5-comparison.md:1

  Scope

  - Previous: mn4/micronaut-servlet, branch 5.6.x, commit 35f37be6bc05, clean
  - Current: mn5/micronaut-servlet, branch 6.0.x, commit b1a8acd12a59, dirty only because of untracked http-server-tomcat/tomcat.8080/logs/access_log.2026-05-06
  - Delta: 123 commits, 182 changed files

  Release Note Draft

  Breaking / Compatibility

  - Upgrades the project line from 5.6.2-SNAPSHOT -> 6.0.0-SNAPSHOT and aligns with Micronaut Framework 4.10.6 -> 5.0.0-RC2.
  - io.micronaut.servlet.engine.ServletCompletedFileUpload is removed/adapted because Micronaut Core’s CompletedFileUpload became sealed; code referencing the servlet-specific implementation should use Micronaut’s multipart
    abstractions instead. See mn5/micronaut-servlet/config/accepted-api-changes.json:78.
  - Servlet HTTP internals now use MessageBodyHandlerRegistry instead of the older codec registry path. See mn5/micronaut-servlet/servlet-core/src/main/java/io/micronaut/servlet/http/ServletHttpHandler.java:95.

  Features

  - Added runtime enablement toggles for servlet runtimes: micronaut.server.jdk.enabled, micronaut.server.jetty.enabled, micronaut.server.tomcat.enabled, micronaut.server.undertow.enabled, and poja.apache.enabled. See mn5/
    micronaut-servlet/src/main/docs/guide/httpServer.adoc:9 and mn5/micronaut-servlet/http-server-jetty/src/main/java/io/micronaut/servlet/jetty/JettyConfiguration.java:52.
  - HTTP POJA blocking work now stays on the POJA request thread by default, with opt-out via micronaut.executors.blocking.*. See mn5/micronaut-servlet/src/main/docs/guide/httpPoja.adoc:1.

  Fixes

  - JDK HttpExchange requests now preserve the raw query string, fixing binding for quoted/encoded query values. See mn5/micronaut-servlet/http-server-jdk/src/main/java/io/micronaut/servlet/http/server/jdk/
    HttpExchangeHttpServletRequest.java:142.
  - WAR servlet initialization now publishes startup/shutdown events and ties the embedded server lifecycle to servlet context destruction. See mn5/micronaut-servlet/servlet-engine/src/main/java/io/micronaut/servlet/engine/
    initializer/MicronautServletInitializer.java:125.
  - Added regression coverage for multipart @Body Map UTF-8 form-field handling. See mn5/micronaut-servlet/http-server-tomcat/src/test/groovy/io/micronaut/servlet/tomcat/TomcatParameterBinding2Spec.groovy:245.
  - Fix candidates also include Jetty static-resource CORS allowed origins and default servlet mapping with eagerInitSingletons.

  Dependency / Platform Changes

  - Gradle wrapper 8.14.3 -> 9.5.0; Micronaut Gradle plugin 4.6.0 -> 5.0.0-M1
  - Jetty 12.1.2 -> 12.1.8; Tomcat 11.0.11 -> 11.0.21; Undertow 2.3.19.Final -> 2.3.24.Final
  - Apache HttpCore 5.3.6 -> 5.4.2; Logback Access 2.0.6 -> 2.0.12
  - Micronaut Logging 1.7.1 -> 2.0.0-M2; Reactor 3.8.0 -> 4.0.0-RC1; Security 4.15.0 -> 5.0.0-M2; Serde 2.15.4 -> 3.0.0-RC1; Session 4.7.0 -> 5.0.0-M2; Validation 4.11.0 -> 5.0.0-RC1
...
Generated: 2026-05-06 15:12 UTC
Comparison: `mn4` -> `mn5`
Mode: git
...
| Current | `/Users/sdelamo/github/micronaut/mn5/micronaut-servlet` | `6.0.x` | `b1a8acd12a59` | `git@github.com:micronaut-projects/micronaut-servlet.git` | `True` |
...
- File changes listed: 182
- Version values listed: 29
- File status counts: A=47, D=1, M=134
...
| `gradle.properties` | `projectVersion` | `5.6.2-SNAPSHOT` | `6.0.0-SNAPSHOT` | `changed` |
...
| `gradle/libs.versions.toml` | `libraries.micronaut-logging` | `io.micronaut.logging:micronaut-logging-bom:1.7.1` | `io.micronaut.logging:micronaut-logging-bom:2.0.0-M2` | `changed` |
...
| `gradle/libs.versions.toml` | `libraries.micronaut-serde` | `io.micronaut.serde:micronaut-serde-bom:2.15.4` | `io.micronaut.serde:micronaut-serde-bom:3.0.0-RC1` | `changed` |
| `gradle/libs.versions.toml` | `libraries.micronaut-session` | `io.micronaut.session:micronaut-session-bom:4.7.0` | `io.micronaut.session:micronaut-session-bom:5.0.0-M2` | `changed` |
| `gradle/libs.versions.toml` | `libraries.micronaut-validation` | `io.micronaut.validation:micronaut-validation-bom:4.11.0` | `io.micronaut.validation:micronaut-validation-bom:5.0.0-RC1` | `changed` |
...
| `gradle/libs.versions.toml` | `versions.micronaut` | `4.10.6` | `5.0.0-RC2` | `changed` |
...
| `gradle/libs.versions.toml` | `versions.micronaut-logging` | `1.7.1` | `2.0.0-M2` | `changed` |
...
| `gradle/libs.versions.toml` | `versions.micronaut-serde` | `2.15.4` | `3.0.0-RC1` | `changed` |
| `gradle/libs.versions.toml` | `versions.micronaut-session` | `4.7.0` | `5.0.0-M2` | `changed` |
